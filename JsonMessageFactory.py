...
class MessageFactory:
    ...
    tenors = ("1H","1H_1H","2H_2F","JUN23_1F","SEP23_1F","DEC23_1F","MAR24_1F","JUN24_1F","SEP24_1F","DEC24_1F","MAR25_1F","JUN25_1F","SEP25_1F","DEC25_1F","MAR26:4Y","4Y_1Y","5Y_1Y","6Y_1Y","7Y_1Y","8Y_1Y",             

            "9Y_1Y","10Y_2Y","12Y_3Y","15Y_5Y","20Y_5Y","25Y_5Y","30Y_5Y","35Y_5Y","40Y_5Y","45Y_5Y","50Y_5Y","55Y_5Y","60Y_10Y")
    ...
    data = {
                ...
                "$schema": "./riskresult.risk.schema.json",
    ...
    def getMessage(self):
        ...
        local_data["header"]["sendingSytem"] = random.choice(self.system)

        local_data["riskResult"]["subject"]["bookId"] = random.choice(self.books)

        local_data["riskResult"]["sensCurrency"] = random.choice(self.ccy)

        for t in self.tenors:

            local_data["riskResult"][t] = random.uniform(0,1e6)
